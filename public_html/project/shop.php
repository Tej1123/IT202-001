...
<nav>
    ...
    <form onsubmit="" method="POST">
        ...
        <button id ="private" type="Private" value="Private" >Add item</button> </form> </div>
        <button id ="private" type="Private" value="Private" >Remove item</button> </form> </div>
        <button id ="private" type="Private" value="Private" >Clear Cart</button> </form> </div>
